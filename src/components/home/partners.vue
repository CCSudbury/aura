                        ...
                        <v-card class="elevation-0 pa-0 ma-0 transparent">
                            <v-container grid-list-sm fluid class="pa-0 ma-0">
                                <v-layout row wrap class="ma-0 pa-0">
                                    ...
                                    >
                                    <v-card flat tile class="d-flex pa-2 ma-1 elevation-1" style="border-radius:5px;border-width: 1px; border-style: solid;">
                                        <a href="https://foundry.laurentian.ca/" target="_blank">
                                        <v-tooltip bottom>
                                            <template v-slot:activator="{ on }">
                                        <v-img
                                            :src="require('@/assets/img/partners/foundry.png')"
                                            :lazy-src="require('@/assets/img/partners/foundry.png')"
                                            aspect-ratio="1.5"
                                            class="black"
                                            v-on="on"
                                        >
                                        ...
                                        <span class="google-font">The Foundry</span>
                                        </v-tooltip>
                                        </a>
                                    </v-card>
                                    </v-flex>
